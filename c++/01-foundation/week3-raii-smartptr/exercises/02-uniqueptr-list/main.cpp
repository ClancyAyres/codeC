...
public:
    ...
    // TODO: 实现 push_back — 在尾部插入
    void push_back(int value) {
        auto newNode = std::make_unique<Node>(value);
        // TODO: 如果链表为空，head_ 和 tail_ 都指向新节点
        // TODO: 否则，将新节点接到 tail_->next，更新 tail_
    }

    // TODO: 实现 push_front — 在头部插入
    void push_front(int value) {
        auto newNode = std::make_unique<Node>(value);
        // TODO: 如果链表为空，head_ 和 tail_ 都指向新节点
        // TODO: 否则，新节点的 next 接管原 head_，head_ 指向新节点
    }

    // TODO: 实现 front — 返回头部值
    int front() const {
        // TODO: 如果链表为空，throw std::runtime_error("IntList::front: list is empty")
        // TODO: 返回 head_->value
        return 0;  // 占位
    }
